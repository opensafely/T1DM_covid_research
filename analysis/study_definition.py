...
study = StudyDefinition(
    ...
    # GEOGRAPHIC RELATED VARIABLES (STP, REGION, PRACTICE)
    ...
    ethnicity=patients.with_these_clinical_events(
     ...
     # COMORBIDITIES/HEALTH BEHAVIOURS AND DIABETES COMPLICATIONS OR OTHER DIABETES-RELATED CHARACTERISTICS (MEASURED PRIOR TO 1ST FEB 2020)
    ...
    #DIABETES DIAGNOSIS AFTER THE PANDEMIC STARTS (IE FIRST RECORD AFTER 02 FEB 2020)
    #FROM PRIMARY CARE
    ...
    #COVID DIAGNOSIS DATE (AS AN OUTCOME OR AS AN EXPOSURE)
